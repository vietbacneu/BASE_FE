...
@Component({
  selector: 'jhi-in-cong-no',
  templateUrl: './in-cong-no.component.html',
  styleUrls: ['./in-cong-no.component.scss']
})
export class InCongNoComponent implements OnInit {
  ...
  private buidForm() {
    ...
    if (this.selectedData) {
      ...
      this.listDonNhap = this.selectedData.congNoChiTietDTOS
      this.listDonNhap.forEach(e => {
        console.log(e.soTienThanhToan)
        this.sum = this.sum + Number.parseInt(e.soTienThanhToan)
      })
    }
  }
