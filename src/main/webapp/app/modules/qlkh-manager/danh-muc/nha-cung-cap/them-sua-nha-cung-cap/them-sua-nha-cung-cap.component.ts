...
@Component({
  ...
  templateUrl: './them-sua-nha-cung-cap.component.html',
  styleUrls: ['./them-sua-nha-cung-cap.component.scss']
})
export class ThemSuaNhaCungCapComponent implements OnInit {
