...
import {ThemSuaPhuongThucThanhToanComponent} from "app/modules/qlkh-manager/danh-muc/phuong-thuc-thanh-toan/them-sua-phuong-thuc-thanh-toan/them-sua-phuong-thuc-thanh-toan.component";

@Component({
    selector: 'jhi-phuong-thuc-thanh-toan',
    templateUrl: './phuong-thuc-thanh-toan.component.html',
    styleUrls: ['./phuong-thuc-thanh-toan.component.scss']
})
export class PhuongThucThanhToanComponent implements OnInit {
    ...
    private buidForm() {
        this.form = this.formBuilder.group({
            maPhuongThuc: [null, Validators.required],
            tenPhuongThuc: [null, Validators.required],
        });
    }
    ...
    openModal(type?: string, selectedData?: any) {
        const modalRef = this.modalService.open(ThemSuaPhuongThucThanhToanComponent, {
            size: "lg",
            backdrop: "static",
            keyboard: false
        });
    ...
    onSubmitDelete(id: any = []) {
        this.spinner.show();
        this.thongTinChungApiService.deletePhuongThuc({id: id}).subscribe(
            res => {
