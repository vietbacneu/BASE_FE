...
import {ThemSuaKhachHangComponent} from "app/modules/qlkh-manager/danh-muc/khach-hang/them-sua-khach-hang/them-sua-khach-hang.component";
...
export class KhachHangComponent implements OnInit {
    ...
    openModal(type?: string, selectedData?: any) {
        const modalRef = this.modalService.open(ThemSuaKhachHangComponent, {
            size: "lg",
            backdrop: "static",
            keyboard: false
        });
    ...
    onSubmitDelete(id: any = []) {
        this.spinner.show();
        this.thongTinChungApiService.deleteKhachHang({id: id}).subscribe(
            res => {
                this.spinner.hide()
