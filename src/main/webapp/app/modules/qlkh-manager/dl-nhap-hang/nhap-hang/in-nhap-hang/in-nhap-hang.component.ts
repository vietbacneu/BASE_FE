...
@Component({
    selector: 'jhi-in-nhap-hang',
    templateUrl: './in-nhap-hang.component.html',
    styleUrls: ['./in-nhap-hang.component.scss']
})
export class InNhapHangComponent implements OnInit {
