...
@Component({
  selector: 'jhi-bc-hoa-don-ban-hang',
  templateUrl: './bc-hoa-don-ban-hang.component.html',
  styleUrls: ['./bc-hoa-don-ban-hang.component.scss']
})
export class BcHoaDonBanHangComponent implements OnInit {
