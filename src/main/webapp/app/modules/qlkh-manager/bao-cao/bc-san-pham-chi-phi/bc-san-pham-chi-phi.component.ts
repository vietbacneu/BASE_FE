...
@Component({
    selector: 'jhi-bc-san-pham-chi-phi',
    templateUrl: './bc-san-pham-chi-phi.component.html',
    styleUrls: ['./bc-san-pham-chi-phi.component.scss']
})

export class BcSanPhamChiPhiComponent implements OnInit {
