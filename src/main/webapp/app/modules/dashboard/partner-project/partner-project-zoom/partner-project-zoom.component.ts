...
@Component({
  selector: "jhi-partner-project-zoom",
  templateUrl: "./partner-project-zoom.component.html",
  styleUrls: ["./partner-project-zoom.component.scss"]
})
export class PartnerProjectZoomComponent implements OnInit {
  ...
  buildData(dataSearch: string) {
    ...
    if (
      ...
      this.partnerContractService.fetchDataDk(dataSearch).subscribe(
        res => {
          this.pieChartData = res.totalMMRemain;
          this.pieChartLabels = res.partnerShortName;
        },
