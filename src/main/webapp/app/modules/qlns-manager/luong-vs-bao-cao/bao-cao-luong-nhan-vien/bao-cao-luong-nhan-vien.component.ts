...
import {ChiTietLuongNhanVienComponent} from "app/modules/qlns-manager/luong-vs-bao-cao/luong-nhan-vien/chi-tiet-luong-nhan-vien/chi-tiet-luong-nhan-vien.component";

@Component({
    selector: 'jhi-bao-cao-luong-nhan-vien',
    templateUrl: './bao-cao-luong-nhan-vien.component.html',
    styleUrls: ['./bao-cao-luong-nhan-vien.component.scss']
})
export class BaoCaoLuongNhanVienComponent implements OnInit {
    ...
    openModal(type?: string, selectedData?: any) {
        const modalRef = this.modalService.open(ChiTietLuongNhanVienComponent, {
            size: "lg",
            backdrop: "static",
            keyboard: false
        });
