...
@Component({
  selector: 'jhi-them-sua-tro-cap',
  templateUrl: './them-sua-tro-cap.component.html',
  styleUrls: ['./them-sua-tro-cap.component.scss']
})
export class ThemSuaTroCapComponent implements OnInit {
  ...
  buildForm() {
    this.form = this.formBuilder.group({
      maTroCap: [null, Validators.required],
      ten: [null, Validators.required],
      mucTroCap: [null, Validators.required],
      mieuTa: [null],
    });
