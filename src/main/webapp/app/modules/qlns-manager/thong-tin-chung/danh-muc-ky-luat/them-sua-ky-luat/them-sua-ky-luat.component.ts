...
@Component({
  selector: 'jhi-them-sua-ky-luat',
  templateUrl: './them-sua-ky-luat.component.html',
  styleUrls: ['./them-sua-ky-luat.component.scss']
})
export class ThemSuaKyLuatComponent implements OnInit {
  ...
  buildForm() {
    this.form = this.formBuilder.group({
      maKyLuat: [null, Validators.required],
      tenLoi: [null, Validators.required],
      mucPhat: [null],
      mieuTa: [null],
    });
  ...
  onSubmit() {
    ...
    const data = {
      id: null,
      maKyLuat: this.form.value.maKyLuat,
      tenLoi: this.form.value.tenLoi,
      mucPhat: this.form.value.mucPhat,
      mieuTa: this.form.value.mieuTa,
    };
    if (this.type === "add") {
      this.thongTinNhanSuApiService
          .createDMKyLuat(data).subscribe(
          res => {
            this.spinner.hide();
