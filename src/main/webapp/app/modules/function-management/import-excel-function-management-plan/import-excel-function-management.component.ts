...
@Component({
  ...
  templateUrl: "./import-excel-function-management.component.html",
  styleUrls: ["./import-excel-function-management.component.scss"]
})
export class ImportExcelFunctionManagementComponent implements OnInit {
